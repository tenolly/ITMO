...
_start:
    ...
    syscall
"""
        (output, code) = self.perform('print_newline', text, '')
        self.assertEqual(output, '\n', 'print_newline printed wrong char: %s' % repr(output))
...
"""
    ...
    def test_print_int(self):
        inputs = ['-1', '-12345234121', '0', '123412312', '123123', '+12123']
        for input in inputs:
            text = """
section .text
_start:
...
"""
    ...
    def test_read_word_too_long(self):
        inputs = [ 'asdbaskdbaksvbaskvhbashvbasdasdads wewe', 'short', '1' * 1000]
        for input in inputs:
            text = """
section .data
...
"""
    ...
    def test_parse_uint(self):
        inputs = ["0", "1234567890987654321hehehey", "1", "123456"]
        for input in inputs:
            text = """
section .data
input: db '""" + input  + """', 0
...
"""
    ...
    def test_parse_int(self):
        inputs = ["0", "1234567890987654321hehehey", "-1dasda", "-eedea", "-123123123", "1", "+131312"]
        for input in inputs:
            text = """
section .data
input: db '""" + input  + """', 0
