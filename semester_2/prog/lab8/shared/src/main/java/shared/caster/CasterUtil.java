package shared.caster;

import java.io.Serializable;
import com.google.common.base.Function;

import shared.commands.exceptions.TerminateException;
...
public class CasterUtil implements Serializable {
    ...
    public static final Function<String, Long> castToLong = (Function<String, Long> & Serializable) arg -> {
        if (arg == null) throw new CasterException("can't be empty");
        if (arg.equals("!exit")) throw new TerminateException();
