...
public class Vehicle implements Comparable<Vehicle>, Serializable {
    ...
    public Vehicle(String name, Coordinates coordinates, Float enginePower, Integer numberOfWheels, 
    float fuelConsumption, FuelType fuelType, String username) throws CasterException {
    ...
    public Integer getNumberOfWheels() {
        if (numberOfWheels == null) return 0;
    ...
    public static class Caster implements Serializable {
        ...
        public static final Function<String, Integer> castToNumberOfWheels = (Function<String, Integer> & Serializable) s -> {
            ...
            if (s != null) {
                numberOfWheels = s.isEmpty() ? null : Integer.parseInt(s);
            } else {
                numberOfWheels = null;
            }
