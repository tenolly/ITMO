...
public class ServerApp {
    ...
    public static final String COLLECTION_FILE = "collection.xml";
    ...
    public static void main(String[] args) {
        ServerEnviroment enviroment = new ServerEnviroment(
            new CollectionHandler(COLLECTION_FILE),
            new CommandHandler()
                .add(new Help("server-help", "outputs all server commands with using explanation"))
                ...
                .add(new Save("save", "save the collection to the file", COLLECTION_FILE))
        ...
        try (SocketsManager socketsManager = new SocketsManager(HOST, PORT)) {
